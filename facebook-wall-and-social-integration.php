...
add_shortcode("mitsol_fbwall_feed_short_code", 'facebook_wall_and_social_integration_replace_scode'); //this code as [mynewnenwe] will b replaced by functions content mikex_replace_keyword2
...
add_filter('widget_text', 'shortcode_unautop'); // enabling short code in default text widget also see echo do_shortcode($var); in widget function
